...
OUTPUT_REPORT = "kasami_corridas_report.txt"  # Reporte de análisis
OUTPUT_HISTOGRAM = "kasami_corridas_histogram.png"  # Gráfico de corridas
...
def main():
    ...
    # --- Generar reporte ---
    report = f"""Análisis de Propiedad de Corridas - Secuencia Kasami
{'='*60}
...
"""
    ...
    plt.title('Distribución de Corridas en Secuencia Kasami')
    ...
    print(f"- Reporte: {os.path.join(output_dir, OUTPUT_REPORT)}")
    print(f"- Histograma: {os.path.join(output_dir, OUTPUT_HISTOGRAM)}")
